...
?>
	<div class="edd-admin-box-inside">
		<p>
			<?php printf( __( '<strong>Upgraded from:</strong> <a href="%s">#%s</a>', 'edd_sl' ), $view_url, edd_get_payment_number( $upgraded_from ) ); ?>&nbsp;
		</p>
	</div>
<?php
	endif;
...
?>
	<div class="edd-admin-box-inside">
		<p>
			<?php printf( __( '<strong>Upgraded to:</strong> <a href="%s">#%s</a>', 'edd_sl' ), $view_url, edd_get_payment_number( $upgraded_to ) ); ?>&nbsp;
		</p>
	</div>
<?php
	endif;
