...
class EDD_Slg_Scripts{
	...
	public function edd_slg_admin_styles( $hook_suffix ) {
		...
		$pages_hook_suffix = array( 'post-new.php', 'post.php', $edd_screen_id.'_page_edd-social-login' );
	...
	public function edd_slg_public_scripts() {
		...
		$fberror = $gperror = $lierror = $twerror = $yherror = $fserror = $wlerror = $vkerror = $insterror = '';
