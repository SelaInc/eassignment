	...
	public function edd_slg_settings( $settings ) {
		...
		$edd_slg_settings = array(
				...
				array(
					...
					'type'		=> 'checkbox',
					'desc'	=> '<p class="description">'.__( 'Check this box to add social login buttons on easy digital download login page and default wordpress login page.','wooslg' ).'</p>'
				),
				array(
					'id'		=> 'edd_slg_display_link_thank_you',
					'name'		=> __( 'Display "Link Your Account" button on Thank You page:', 'eddslg' ),
					'type'		=> 'checkbox',
					'desc'	=> '<p class="description">'.__( ' Check this box to allow customers to link their social account on the Thank You page for faster login & checkout next time they purchase.','wooslg' ).'</p>'
				),
