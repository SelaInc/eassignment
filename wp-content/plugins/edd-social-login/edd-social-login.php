 ...
 * Description: Allow your customers to login and checkout with social networks such as Facebook, Twitter, Google, Yahoo, LinkedIn, Foursquare, Windows Live, VK.com and Instagram.
 * Version: 1.6.1
 * Author: WPWeb
...
if( !defined( 'EDD_SLG_VERSION' ) ) {
	define( 'EDD_SLG_VERSION', '1.6.1' ); // Plugin version
}
...
function edd_slg_install() {
	...
	if( !isset( $edd_options['woo_slg_display_link_thank_you'] ) ) {
		$edd_options['woo_slg_display_link_thank_you'] =  '';
		$udpopt = true;
	}//end if
